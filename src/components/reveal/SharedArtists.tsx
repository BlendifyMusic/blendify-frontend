            ...
            >
              ...
              >
                {artist.imageUrl ? (
                  ...
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#1DB954] to-teal-600 flex items-center justify-center text-2xl font-bold">
                    {artist.name.charAt(0)}
                  </div>
                )}
                <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-[#1DB954] flex items-center justify-center">

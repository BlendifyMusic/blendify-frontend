  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex items-center gap-3 px-6 py-3.5 rounded-full bg-white/[0.04] border border-white/[0.07] hover:border-[#d4483b]/30 hover:bg-[#d4483b]/10 transition-all hover:scale-[1.04] active:scale-[0.97]"
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="#d4483b">
        ...
        <span className="font-medium text-[14px] text-white/70">Last.fm</span>
      </motion.button>

      <motion.button
        variants={fadeInUp}
        onClick={() => handleSelect('ytmusic')}
        className="flex items-center gap-3 px-6 py-3.5 rounded-full bg-white/[0.04] border border-white/[0.07] hover:border-[#FC3C44]/30 hover:bg-[#FC3C44]/10 transition-all hover:scale-[1.04] active:scale-[0.97]"
      >
        ...
        <span className="font-medium text-[14px] text-white/70">YouTube Music</span>
      </motion.button>
    </motion.div>
  );
}

...
export function PlatformPicker({ blendId }: { blendId?: string }) {
  const handleSelect = (platform: 'spotify' | 'ytmusic') => {
  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-[#1DB954]/10 border border-[#1DB954]/30 hover:bg-[#1DB954]/20 transition-all hover:scale-105 active:scale-95"
      >
